...
一个采用 **Monorepo** 架构开发的 Cesium 扩展库集合，基于 Cesium v1.141.0 构建，旨在提供高质量、可复用的 3D 地理可视化功能扩展。
...
| 包名                                  | 版本  | 描述                                     |
| ------------------------------------- | ----- | ---------------------------------------- |
| [cesium-exts](./packages/cesium-exts) | 1.0.0 | 核心扩展库，包含热力图、风场等可视化组件 |
...
**注意**: 本项目基于 Cesium v1.141.0 开发，请确保使用兼容版本的 Cesium。
